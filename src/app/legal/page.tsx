  ...
  return (
    <main className="max-w-xl mx-auto px-5 py-16 leading-relaxed">
      ...
      <p className="text-haze text-sm mb-10">
        StillHome is operated by The 36th Company Ltd (United Kingdom), with
        fulfilment in Nigeria by The 36th Solutions Ltd. Last updated July 2026.
      </p>
      ...
      <p className="text-haze mb-8">
        ...
        at checkout — StillHome is not a money transfer or remittance service and
        does not send, hold or convert money on your behalf. The naira value
        shown describes the product you are buying, not an exchange we perform
        for you.
      </p>
      ...
      <p className="text-haze mb-8">
        ...
        for the meter, smartcard or phone number you entered. Please check it
        ...
        different meter or account, or refunded — this is a restriction imposed
        by the Nigerian service providers themselves.
      </p>

      <h2 className="font-display font-semibold text-xl mb-3">Refund policy</h2>
      <p className="text-haze mb-4">In plain terms:</p>
      <p className="text-haze mb-8">
      ...
      <p className="text-haze mb-8">
        Support: support@stillhome.example — replace with your live support
        address before launch. The 36th Company Ltd, registered in England and
        Wales.
      </p>
